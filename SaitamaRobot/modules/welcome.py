    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Subarashii! A Heaven Canceller just joined, be at your best.",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Huh! Meltdowner level joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Huh! Someone with a Gender Equal Face Puncher Dude disaster level just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "Ara, ara! Wasabi level user just joined. Dangerous.",
                    reply_to_message_id=reply)
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oh no, papa left..", reply_to_message_id=reply)
                return

            # Give the devs a special goodbye
            elif left_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "Today the universe lost another bright star.",
                    reply_to_message_id=reply,
                )
                return
